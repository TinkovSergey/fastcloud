...
<section class="fc-story">
  <div class="fc-story-inner">
    ...
    <div class="fc-story-visual fc-map-visual">
      ...
      <div class="fc-map-hud fc-map-hud-br">
        <span style="font-family:var(--fc-mono);font-size:10px;color:var(--fc-text3);">ближайший&nbsp;узел</span>
        <span style="font-family:var(--fc-mono);font-size:11px;font-weight:600;color:var(--fc-text);">fra1&nbsp;<span style="color:var(--fc-accent)">·&nbsp;12&nbsp;ms</span></span>
      </div>
        <svg class="fc-map-svg" viewBox="0 8 125.762 72" xmlns="http://www.w3.org/2000/svg">
          <defs>
            ...
            <path id="fc-arc-eu-au" d="M 55 21 Q 90 14 118 60" fill="none"/>
            ...
            <path id="fc-arc-ue-eu" d="M 27 29 Q 42 12 55 21" fill="none"/>
          </defs>
          ...
          <circle class="dc-dot-map" cx="59" cy="25" r="0.9" filter="url(#fcglow)"/>
          <circle class="dc-dot-map" cx="63" cy="20" r="0.9" filter="url(#fcglow)"/>
          <text class="dc-lbl-map" x="58" y="16">EU &times;5</text>
          ...
          <use href="#fc-arc-eu-au"  class="arc-map" style="animation-duration:8s;animation-delay:-3s"/>
          ...
          <use href="#fc-arc-ue-eu"  class="arc-map" style="animation-duration:7.5s;animation-delay:-3.4s"/>
          <circle cx="55" cy="21" r="1.2" fill="rgba(181,245,58,.5)" class="dc-pulse-map"/>
          <circle cx="101" cy="44" r="1.2" fill="rgba(181,245,58,.5)" class="dc-pulse-map" style="animation-delay:.8s"/>
          <circle cx="9"  cy="25" r="1.2" fill="rgba(181,245,58,.5)" class="dc-pulse-map" style="animation-delay:1.6s"/>
          <circle class="pkt-map" r=".55"><animateMotion dur="4.6s" repeatCount="indefinite"><mpath href="#fc-arc-eu-sg"/></animateMotion></circle>
          <circle class="pkt-map" r=".5"><animateMotion dur="5.2s" begin="-2s" repeatCount="indefinite"><mpath href="#fc-arc-eu-au"/></animateMotion></circle>
          ...
          <circle class="pkt-map" r=".5"><animateMotion dur="3.4s" begin="-0.5s" repeatCount="indefinite"><mpath href="#fc-arc-eu-in"/></animateMotion></circle>
          ...
          <circle class="pkt-map" r=".5"><animateMotion dur="2.4s" begin="-1s" repeatCount="indefinite"><mpath href="#fc-arc-uw-ue"/></animateMotion></circle>
        </svg>
    </div>
  </div>
</section>
