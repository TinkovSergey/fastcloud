      ...
      <div class="fc-map-hud">
        ...
        <svg class="fc-map-svg" viewBox="0 8 125.762 72" xmlns="http://www.w3.org/2000/svg">
          <defs>
            ...
            <path id="fc-a1"  d="M 9 25 Q 14 14 19 23"   fill="none"/>
            <path id="fc-a2"  d="M 19 23 Q 35 7 52 20"   fill="none"/>
            <path id="fc-a3"  d="M 9 25 Q 30 5 52 20"    fill="none"/>
            <path id="fc-a4"  d="M 30 28 Q 41 13 52 20"  fill="none"/>
            <path id="fc-a5"  d="M 52 20 Q 57 12 63 19"  fill="none"/>
            <path id="fc-a6"  d="M 52 20 Q 70 7 88 35"   fill="none"/>
            <path id="fc-a7"  d="M 52 20 Q 76 5 101 44"  fill="none"/>
            <path id="fc-a8"  d="M 63 19 Q 68 11 73 17"  fill="none"/>
            <path id="fc-a9"  d="M 73 17 Q 87 9 101 44"  fill="none"/>
            <path id="fc-a10" d="M 88 35 Q 94 29 101 44" fill="none"/>
            <path id="fc-a11" d="M 101 44 Q 107 39 113 52" fill="none"/>
            <path id="fc-a12" d="M 101 44 Q 109 43 117 60" fill="none"/>
          </defs>
          ...
          <!-- abstract nodes — not tied to specific datacenters -->
          <circle class="dc-dot-map" cx="9"   cy="25" r="0.9" filter="url(#fcglow)"/>
          <circle class="dc-dot-map" cx="19"  cy="23" r="0.9" filter="url(#fcglow)"/>
          <circle class="dc-dot-map" cx="30"  cy="28" r="0.9" filter="url(#fcglow)"/>
          <circle class="dc-dot-map" cx="52"  cy="20" r="0.9" filter="url(#fcglow)"/>
          <circle class="dc-dot-map" cx="63"  cy="19" r="0.9" filter="url(#fcglow)"/>
          <circle class="dc-dot-map" cx="73"  cy="17" r="0.9" filter="url(#fcglow)"/>
          <circle class="dc-dot-map" cx="88"  cy="35" r="0.9" filter="url(#fcglow)"/>
          <circle class="dc-dot-map" cx="101" cy="44" r="0.9" filter="url(#fcglow)"/>
          <circle class="dc-dot-map" cx="113" cy="52" r="0.9" filter="url(#fcglow)"/>
          <circle class="dc-dot-map" cx="117" cy="60" r="0.9" filter="url(#fcglow)"/>
          <!-- arcs -->
          <use href="#fc-a1"  class="arc-map" style="animation-duration:3.8s;animation-delay:-.4s"/>
          <use href="#fc-a2"  class="arc-map" style="animation-duration:6.2s;animation-delay:-1.2s"/>
          <use href="#fc-a3"  class="arc-map" style="animation-duration:8s;animation-delay:-2.6s"/>
          <use href="#fc-a4"  class="arc-map" style="animation-duration:5.4s;animation-delay:-1.8s"/>
          <use href="#fc-a5"  class="arc-map" style="animation-duration:4.2s;animation-delay:-.7s"/>
          <use href="#fc-a6"  class="arc-map" style="animation-duration:5.8s;animation-delay:-2s"/>
          <use href="#fc-a7"  class="arc-map" style="animation-duration:7.4s;animation-delay:-3.2s"/>
          <use href="#fc-a8"  class="arc-map" style="animation-duration:3.6s;animation-delay:-.2s"/>
          <use href="#fc-a9"  class="arc-map" style="animation-duration:6.6s;animation-delay:-2.4s"/>
          <use href="#fc-a10" class="arc-map" style="animation-duration:4s;animation-delay:-.9s"/>
          <use href="#fc-a11" class="arc-map" style="animation-duration:4.8s;animation-delay:-1.4s"/>
          <use href="#fc-a12" class="arc-map" style="animation-duration:6s;animation-delay:-3.8s"/>
          <!-- pulse rings on hub nodes -->
          <circle cx="52"  cy="20" r="1.2" fill="rgba(181,245,58,.5)" class="dc-pulse-map"/>
          <circle cx="101" cy="44" r="1.2" fill="rgba(181,245,58,.5)" class="dc-pulse-map" style="animation-delay:.6s"/>
          <circle cx="9"   cy="25" r="1.2" fill="rgba(181,245,58,.5)" class="dc-pulse-map" style="animation-delay:1.2s"/>
          <circle cx="63"  cy="19" r="1.2" fill="rgba(181,245,58,.5)" class="dc-pulse-map" style="animation-delay:1.9s"/>
          <!-- packets -->
          <circle class="pkt-map" r=".55"><animateMotion dur="4.6s" repeatCount="indefinite"><mpath href="#fc-a7"/></animateMotion></circle>
          <circle class="pkt-map" r=".5" ><animateMotion dur="5.2s" begin="-2s"   repeatCount="indefinite"><mpath href="#fc-a3"/></animateMotion></circle>
          <circle class="pkt-map" r=".55"><animateMotion dur="4s"   begin="-1.4s" repeatCount="indefinite"><mpath href="#fc-a2"/></animateMotion></circle>
          <circle class="pkt-map" r=".5" ><animateMotion dur="3.4s" begin="-0.5s" repeatCount="indefinite"><mpath href="#fc-a6"/></animateMotion></circle>
          <circle class="pkt-map" r=".45"><animateMotion dur="3.2s" begin="-2.8s" repeatCount="indefinite"><mpath href="#fc-a10"/></animateMotion></circle>
          <circle class="pkt-map" r=".5" ><animateMotion dur="2.8s" begin="-1s"   repeatCount="indefinite"><mpath href="#fc-a5"/></animateMotion></circle>
          <circle class="pkt-map" r=".45"><animateMotion dur="4s"   begin="-3s"   repeatCount="indefinite"><mpath href="#fc-a9"/></animateMotion></circle>
          <circle class="pkt-map" r=".5" ><animateMotion dur="3.8s" begin="-1.6s" repeatCount="indefinite"><mpath href="#fc-a12"/></animateMotion></circle>
          <circle class="pkt-map" r=".45"><animateMotion dur="5s"   begin="-2.2s" repeatCount="indefinite"><mpath href="#fc-a11"/></animateMotion></circle>
        </svg>
    </div>
  </div>
</section>
