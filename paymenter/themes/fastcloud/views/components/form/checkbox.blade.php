<div class="flex items-center {{ $divClass ?? '' }}">
    ...
    <input type="checkbox" name="{{ $name }}" id="{{ $id ?? $name }}"
        ...
        class="form-checkbox size-4 text-primary rounded focus:ring-primary hover:bg-primary ring-offset-primary-800 focus:ring-2 bg-background-secondary border-neutral" />
