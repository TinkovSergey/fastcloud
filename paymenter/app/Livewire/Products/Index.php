...
class Index extends Component
{
    ...
    {
        $this->products = $this->category->products()->where('hidden', false)->with(['category', 'plans.prices.currency', 'configOptions.children.plans.prices.currency'])->orderBy('sort')->get();
